...
<!-- Доброго времени суток!
 ...
 Нас же интересует не реальный мир, а объекты виртуального мира, который мы будем вытаскивать с той стороны экрана к нам на стол/полку/витринку.<br></p>
		...
		<p> Для тех, кто еще не знаком с основами моделирования в среде 3DМАХ - ОБЯЗАТЕЛЬНО выучите и выполните уроки от уважаемого ACTIVATOR (эти уроки были на форуме, но их удалили. А т.к. считаю их очень полезными "на старте", решил сохранить)<br> 
			<a href="https://nes1.ru/files/APG_2_-_Lessons_part_1_of_3.rar" title="проектирование бумажных моделей в среде 3D MAX" target="_blank" rel= "noopener noreferrer">урок1&nbsp;&nbsp;<i class="fa fa-external-link" aria-hidden="true" style="font-size:12px"></i></a><br>
			<a href="https://nes1.ru/files/APG_2_-_Lessons_part_2_of_3.rar" title="проектирование бумажных моделей в среде 3D MAX" target="_blank" rel= "noopener noreferrer">урок2&nbsp;&nbsp;<i class="fa fa-external-link" aria-hidden="true" style="font-size:12px"></i></a><br>
			<a href="https://nes1.ru/files/APG_2_-_Lessons_part_3_of_3.rar" title="проектирование бумажных моделей в среде 3D MAX" target="_blank" rel= "noopener noreferrer">урок3&nbsp;&nbsp;<i class="fa fa-external-link" aria-hidden="true" style="font-size:12px"></i></a><br>
		</p>&nbsp;
		...
		<p>1. Удалив все не нужное (именно удалив, а не скрыв), выровняйте фигуру по всем 3м осям по центру. 
			Старайтесь поставить объект СТРОГО перпендикулярно плоскости XY и вдоль оси Z. 
