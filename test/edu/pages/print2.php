<!-- форматируем контент под печать === https://legkovopros.ru/questions/12848/est-li-reshenie-cz-z-dlya-verxnix-i-nizhnix-kolontitulov-pri-pechati-dublikat -->
<!-- убираем колонтитулы браузера === http://qaru.site/questions/95744/remove-header-and-footer-from-windowprint -->
<!DOCTYPE html>
