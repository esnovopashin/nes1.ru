	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/Ashen_wand_title_1.jpg" rel="zoom">
				<img src="<?=$adress?>/Ashen_wand_title_150.jpg" <?=$alting?> width="150px" border="0"></a>
			</div>
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Ashen Wand<br>
                  <strong>Формат А4:</strong> 1 лист <br>
                  <strong>Деталей:</strong> 6<br>
                  <strong>H. Высота:</strong> 200 mm<br>
                  <strong>D. Длина:</strong> 14 mm<br>
                  <strong>W. Ширина:</strong> 72 mm<br>
