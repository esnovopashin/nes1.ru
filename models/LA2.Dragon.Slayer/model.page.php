	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/ds_title1.jpg" rel="zoom">
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Dragon Slayer<br>
					<strong>Формат А4:</strong> 1 лист <br>
					<strong>Деталей:</strong> 9<br>
					<strong>H. Высота:</strong> 200 mm<br>
					<strong>D. Длина:</strong> 46 mm<br>
					<strong>W. Ширина:</strong> 130 mm<br>
					<strong>Сложность:</strong>от 9 лет<br>&nbsp;<br>
				</div>
				<div class="dash" style="padding-left:10px">
					<a href=https://yadi.sk/d/Om9TIYYJEJknp>Cкачать</a><br>&nbsp;<br>
				</div>
