	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/Y_title.jpg" rel="zoom">
				<img src="<?=$adress?>/Y_title_s.jpg" <?=$alting?> width="150px" border="0"></a>
			</div>
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Yaxa Mace<br>
					<strong>Формат А4:</strong> 2 листа <br>
					<strong>Деталей:</strong> 29<br>
					<strong>H. Высота:</strong> 250 mm<br>
					<strong>D. Длина:</strong> 122 mm<br>
					<strong>W. Ширина:</strong> 122 mm<br>
					<strong>Сложность:</strong> от 9 лет<br>&nbsp;<br>
				</div>
				<div class="dash" style="padding-left:10px">
					<a href=https://yadi.sk/d/NKk5ebndDzEG2>Cкачать</a><br>&nbsp;<br>
				</div>
