	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/GoblinBardswordOfTheSavage_title_1_800.jpg" rel="zoom">
				<img src="<?=$adress?>/GoblinBardswordOfTheSavage_title_1_200.jpg" <?=$alting?> width="150px" border="0"></a>
			</div>
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Goblin Bardsword Of The Savage <br>
