...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Sirra`s Blade (beta)<br>
					<strong>Формат А4:</strong> 2 листа <br>
					<strong>Деталей:</strong> <br>
					<strong>H. Высота:</strong> 250 mm<br>
					<strong>D. Длина:</strong> 13 mm<br>
					<strong>W. Ширина:</strong> 66 mm<br>
					<strong>Сложность:</strong>от 9 лет<br>&nbsp;<br>
				</div>
				<div class="dash" style="padding-left:10px">
					<a href=https://yadi.sk/d/egdsTW0QEBa7k>Cкачать</a><br>&nbsp;<br>
				</div>
