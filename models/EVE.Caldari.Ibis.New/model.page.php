	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/blueprint_ibis.new_0.jpg" rel="zoom">
				<img src="<?=$adress?>/blueprint_ibis_550.jpg" <?=$alting?> width="150px" border="0"></a>
				<br>&nbsp;<br>&nbsp;
			</div>
			...
			<div class="modelcard">
				...
				<div class="dash contentbox"  style="padding-left:10px">
					<a href="<?=$adress?>/blueprint_ibis.new4_800_w.jpg" rel="zoom">
					<img src="<?=$adress?>/blueprint_ibis.new4_200_w.jpg" <?=$alting?> width="100px" border="0" style="margin:5px"></a> 
				</div>
...
?>
				<div class="dash contentbox" style="padding-left:10px">
				  <strong>Название:</strong> Бумажная модель корабля Ibis (new) =EVE online=<br>
