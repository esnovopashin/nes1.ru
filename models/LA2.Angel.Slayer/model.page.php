	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/AngelSlayer_title_1.jpg" rel="zoom">
				<img src="<?=$adress?>/AngelSlayer_title_r.jpg" <?=$alting?> width="150px" border="0"></a>
			</div>
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Angel Slayer<br>
					<strong>Формат А4:</strong> 1 лист <br>
					<strong>Деталей:</strong> <br>
					<strong>H. Высота:</strong> 250 mm<br>
					<strong>D. Длина:</strong> 9 mm<br>
					<strong>W. Ширина:</strong> 71 mm<br>
					<strong>Сложность:</strong> от 9 лет<br>&nbsp;<br>
				</div>
				<div class="dash" style="padding-left:10px">
					<a href=https://yadi.sk/d/35K14f9tEBa36>Cкачать</a><br>&nbsp;<br>
				</div>
