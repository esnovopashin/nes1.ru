	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/FieryPolishedShiv_title1.jpg" rel="zoom">
				<img src="<?=$adress?>/FieryPolishedShiv_title150.jpg" <?=$alting?> width="150px" border="0"></a>
			</div>
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Fiery Polished Shiv<br>
                  <strong>Формат А4:</strong> 1 лист <br>
                  <strong>Деталей:</strong> 14<br>
                  <strong>H. Высота:</strong> 250 mm<br>
                  <strong>D. Длина:</strong> 28 mm<br>
                  <strong>W. Ширина:</strong> 59 mm<br>
                  <strong>Сложность:</strong> от 9 лет<br>&nbsp;<br>
				</div>
				<div class="dash" style="padding-left:10px">
					<a href=https://yadi.sk/d/3ZqUQ7GsEN5MJ>Cкачать</a><br>&nbsp;<br>
				</div>
