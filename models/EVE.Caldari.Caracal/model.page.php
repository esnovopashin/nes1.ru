	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/blueprint_Caracal_4_800_w.jpg" rel="zoom">
				<img src="<?=$adress?>/blueprint_Caracal_3_200_w.jpg" <?=$alting?> width="150px" border="0"></a>
				<br>&nbsp;<br>&nbsp;
			</div>
...
?>
				<div class="dash contentbox" style="padding-left:10px">
				  <strong>Название:</strong> Бумажная модель корабля Caracal =EVE online=<br>
