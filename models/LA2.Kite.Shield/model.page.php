	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/KiteShield_title_1.jpg" rel="zoom">
				<img src="<?=$adress?>/KiteShield_title_150.jpg" <?=$alting?> width="150px" border="0"></a>
			</div>
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Kite Shield<br>
                  <strong>Формат А4:</strong> 2 листа <br>
                  <strong>Деталей:</strong> 3<br>
				...
				<div class="dash" style="padding-left:10px">
					<a href=https://yadi.sk/d/G2qU7uWzEML25>Cкачать</a><br>&nbsp;<br>
				</div>
