	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/BerylIronEclipse_title_1.jpg" rel="zoom">
				<img src="<?=$adress?>/BerylIronEclipse_title_150.jpg" <?=$alting?> width="150px" border="0"></a>
			</div>
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Beryl Iron Eclipse<br>
                  <strong>Формат А4:</strong> 1 лист <br>
                  <strong>Деталей:</strong> 12<br>
                  <strong>H. Высота:</strong> 200 mm<br>
                  <strong>D. Длина:</strong> 44 mm<br>
                  <strong>W. Ширина:</strong> 132 mm<br>
                  <strong>Сложность:</strong> от 9 лет<br>&nbsp;<br>
				</div>
				<div class="dash" style="padding-left:10px">
					<a href=https://yadi.sk/d/WgkLRB3kENCkJ>Cкачать</a><br>&nbsp;<br>
				</div>
