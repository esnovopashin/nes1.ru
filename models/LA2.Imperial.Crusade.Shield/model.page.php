	...
	<div class="base">
		...
		<div class="cut contentbox row">
			...
			<div class="modelcard-img">
				<a href="<?=$adress?>/ImperialCrusaderShield_title_1.jpg" rel="zoom">
				<img src="<?=$adress?>/ImperialCrusaderShield_title_150.jpg" <?=$alting?> width="150px" border="0"></a>
			</div>
...
?>
				<div class="dash" style="padding-left:10px">
					<strong>Название:</strong> Imperial Crusader Shield<br>
                  <strong>Формат А4:</strong> 2 листа <br>
                  <strong>Деталей:</strong> 13<br>
                  <strong>H. Высота:</strong> 200 mm<br>
                  <strong>D. Длина:</strong> 22 mm<br>
                  <strong>W. Ширина:</strong> 141 mm<br>
                  <strong>Сложность:</strong> от 9 лет<br>&nbsp;<br>
				</div>
				<div class="dash" style="padding-left:10px">
					<a href=https://yadi.sk/d/5a-nk0P5EBaAy>Cкачать</a><br>&nbsp;<br>
				</div>
